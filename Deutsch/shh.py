...
while(a!='0'):
    ...
    if a == '0':
        ...
        if reg == '1':
            ...
            new_name = input()
            print("Введите первый пароль:")
            pass1 = input()
            print("Введите второй пароль:")
            pass2 = input()
            print("Введите третий пароль:")
            pass3 = input()
            fl = open(namesfl,'a',encoding='UTF-8')
            fl.write(f'\n{new_name} {pass1} {pass2} {pass3}')
            fl.close()
...
#---------------------------------------------------------------------------------------------
                             ...
                             if not check:
                                 ...
                                 for L in keys_L:
                                     print(f'\t{j}) {L}')
                                     j += 1
                                 c = input('Введите номер товара для удаления: ')
                                 if c.isdigit():
                                     c_int = int(c)
                                     if 1 <= c_int <= len(keys_L):
                                         del check[keys_L[c_int - 1]]
                                         print('Товар удален.')
                                     else:
